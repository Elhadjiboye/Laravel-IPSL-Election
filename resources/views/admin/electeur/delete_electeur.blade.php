...
<div class="modal fade" id="deleteModal{{ $electeur->id }}">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="{{ route('electeur.delete',$electeur->id) }}">
              @csrf
              @method('DELETE')
                <input type="hidden" class="id" name="id">
                <div class="text-center">
                    <p>ÊTES-VOUS SÛR DE VOULOIR SUPPRIMER CET ELECTEUR ?</p>
